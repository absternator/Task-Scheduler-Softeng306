...
public class compareCategorisedGraphs6p {
    ...
    public void testDiamond() throws IOException {
        _args = new String[]{"src/test/resources/1R1L-HalfDiamond.dot", "6"};
        CompareAlgorithms.compareAlgorithmsFor(_args);
    }
    ...
    public void testBinaryTree() throws IOException {
        _args = new String[]{"src/test/resources/1R10L-BinaryTree.dot", "6"};
        CompareAlgorithms.compareAlgorithmsFor(_args);
    }

    @Test(timeout = _timeout)
    public void testPairs() throws IOException {
        _args = new String[]{"src/test/resources/5R5L-Pairs.dot", "6"};
        CompareAlgorithms.compareAlgorithmsFor(_args);
    }

    @Test(timeout = _timeout)
    public void testTriangles() throws IOException {
        _args = new String[]{"src/test/resources/7R13L-Triangles.dot", "6"};
        CompareAlgorithms.compareAlgorithmsFor(_args);
    }

    @Test(timeout = _timeout)
    public void testHalfReverseHarem() throws IOException {
        _args = new String[]{"src/test/resources/9R1L-HalfReverseHarem.dot", "6"};
        CompareAlgorithms.compareAlgorithmsFor(_args);
    }

    @Test(timeout = _timeout)
    public void testReverseBinaryTree() throws IOException {
        _args = new String[]{"src/test/resources/10R1L-ReverseBinaryTree.dot", "6"};
        CompareAlgorithms.compareAlgorithmsFor(_args);
    }

    @Test(timeout = _timeout)
    public void testReverseTrianglesTree() throws IOException {
        _args = new String[]{"src/test/resources/13R7L-ReverseTriangles.dot", "6"};
        CompareAlgorithms.compareAlgorithmsFor(_args);
    }
}
